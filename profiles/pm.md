...
4. **Abweichung aufbereiten:** Bei einer ausreichend beschriebenen Abweichung einen kurzen **Bug-Entwurf, nicht erstellt** formulieren. Enthalten sind Titel, Ticketbezug, bekannte Umgebung/Stand, Voraussetzungen, tatsächlich ausgeführte Schritte, Erwartung samt Quelle, beobachtetes Verhalten und verfügbare Belege. Fehlende entscheidende Angaben als offen benennen und gezielt nachfragen; der Entwurf darf trotzdem schon nutzbar sein. Keine Ursache, Priorität, Häufigkeit oder Reproduzierbarkeit erfinden. Bei ungeklärter Anforderung stattdessen einen Klärungspunkt formulieren. Nichts automatisch in Jira anlegen oder kommentieren.
5. **Abschließen oder fortsetzen:** Auf Wunsch stoppen und den Zwischenstand ausgeben. Am Ende die Fälle mit Ergebnis und verbleibenden Lücken zusammenfassen. Ungeprüfte Fälle bleiben offen; einzelne bestandene Fälle sind keine vollständige Ticketabnahme, Freigabe oder Live-Bestätigung. Die abschließende Freigabe bleibt beim zuständigen Menschen. Bei „weiter“ am nächsten offenen Fall fortsetzen, erledigte Fälle nicht ungefragt wiederholen. Wechseln Umgebung, Produktstand oder relevante Anforderungen, betroffene alte Ergebnisse als veraltet kennzeichnen und erneut prüfen.
