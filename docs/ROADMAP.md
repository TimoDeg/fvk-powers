...
**Stand 25.09.2026** (Belege im [Prüfstand](VALIDATION.md)):
...
| C | Gebaut und erweitert: Profil wird automatisch aus dauerhaften Angaben gepflegt und im neuen Chat angewendet (Setup-Matrix 4/4). |
| D | D2 und D3 (ohne Container) gebaut: `fresh_env.py`, realistischer Jira-Stub, leeres HOME, Setup-Matrix mit 20 Grenzfällen (19/20). D1 mit echtem PM offen. |
...
| neu | Automatisches lokales Gedächtnis (Ticketnotiz, Profil, Glossar) und fachliche Rückfragen. PM-Coding-Harness folgt später; Code-Aufträge von PMs sind erlaubt. |
