# Prüfhistorie bis 24.09.2026

Chronologisches Protokoll früherer Regelstände, unverändert übernommen. Der aktuelle Stand steht im [Prüfstand](VALIDATION.md).
...
## Isolierte Erststarts und Phase-1-Pakete — 24.09.2026
...
## Regelumbau — 23.09.2026: ein Belegmodell, blinder A/B-Lauf

> **Nachtrag 24.09.2026:** Codex hat in Eval-Läufen persönliche Skills des Betreuers (auch als deaktiviert markierte) angeboten und teils gelesen; die Codex-Zahlen unten sind dadurch möglicherweise beeinflusst. Ob Claude Code mit `--setting-sources project` persönliche Skills ausblendet, ist nicht geprüft. Seit 24.09. läuft Codex in einem leeren HOME.
